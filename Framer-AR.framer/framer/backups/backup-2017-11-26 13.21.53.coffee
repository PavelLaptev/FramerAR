...
ARlayer = new Layer
	...
	html: """<iframe id="aframe" allowfullscreen="true" sandbox="allow-scripts allow-pointer-lock allow-same-origin allow-popups allow-modals allow-forms" allowtransparency="true" width="#{Screen.width}" height="#{Screen.height}" src="modules/iframeAR.html"></iframe>"""
